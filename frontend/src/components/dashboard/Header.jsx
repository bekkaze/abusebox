...
import { HiOutlineLogout, HiShieldCheck, HiMoon, HiSun } from 'react-icons/hi';
...
export default function Header() {
  ...
  return (
    <header className='h-16 px-6 flex items-center justify-between border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800'>
      <div>
